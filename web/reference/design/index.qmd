...
Phase shift oscillators produce sinusoidal outputs.  The oscillation frequency in Hz is given by $f_{osc} = \sqrt{3}/(2\pi RC)$. The oscillation amplitude is hard to control, but we've seen ~ 1 Vpp in the past. Since this requires four op-amps, it's natural to implement it on one MCP6004.

## Maximum and Minimum Detectors

::: {#fig-minmax layout-ncol="2"}

![Max Detector](img/phase_shift_osc.png){#fig-phase-shift-osc}

![Min Detector](img/phase_shift_osc.png){#fig-phase-shift-osc}
