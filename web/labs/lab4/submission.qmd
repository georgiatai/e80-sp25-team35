...
- [ ] Provides a table of results that matches the form below with at least five data points.  Note the following: 
  ...
  - One table row should be for 1m of depth, but it will only contain predicted values because the graduated cylinders are shorter than 1 m.
- [ ] Predicted Voltages and measured voltages match to within uncertainty and are consistent with equations.
- [ ] Predicted and measured Voltage at zero depth is close to 0.1 V.
- [ ] Predicted Voltage at 1m depth is close to 3.1V
...
- [ ] Predicted Voltages and measured voltages match to within uncertainty and are consistent with equations.
- [ ] Predicted and measured Voltage at 0 °C is close to 0.1 V.
- [ ] Predicted and measured Voltage at 20 °C is close to 3.1 V.
