...
## CFD Simulations of Cylindrical Objects

In this section we will perform fluid dynamics simulations of the same objects that are being tested in the wind tunnel. This will offer us a chance to compare simulation and reality. We will also use similitude to compare our wind tunnel results against a simulation of a full-sized robot traveling in water.
...
What are the appropriate reference area and characteristic length to determine the lift force and coefficient of lift for the flat plate?  
