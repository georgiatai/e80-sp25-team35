...
The E80 robot code appears in three files: `E80_Lab_07_dive.ino`, `E80_Lab_07_surface.ino` and `Default_Robot.ino`.  We intend for you to use `Default_Robot.ino` on your final project, but you should modify `E80_Lab_07_dive.ino` and `E80_Lab_07_surface.ino` this week.  Look at `E80_Lab_07_dive.ino` in this section.

:::{.callout-note collapse="true"}
## Why Three Files for the E80 Robot Code?

The dive and surface programs are simplified versions of `Default_Robot.ino`, so they're easier to learn from.  The dive and surface programs also have a few key functions removed, so that you have to figure them out on your own when writing control loops later.  If you're stuck, feel free to look at `Default_Robot.ino` for inspiration to write those functions, but it's intended that you figure out and write your own control laws this week.
:::
