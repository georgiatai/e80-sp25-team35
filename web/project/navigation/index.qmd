...
In this lab you are going to test out using your IMU data to dead reckon a course, which is an echo of the work that you did in lab 1.  Then you are going to learn about or assemble a new sensor and your [E80 protoboard](/reference/board), then finally you'll to modify your robot software to implement a control loop. One crucial difference between this activity and a normal lab is that you will practice these skills by doing different activities depending on your project.  You will select one of the following activities to pursue during this lab:
...
- [ ] Modify and use your protoboard
