Week 1 Proposal Checkoff Checklist
...
There are a lot of things to remember to check off during the first week (unlike later weeks, which are pretty self-explanatory). Please make sure you hit all the topics on this list. The point of this list is to help make your design as robust as possible and to make your launch at Dana Point a smashing success.
...
Have advised team on expected difficulty of their proposed project, made sure they all bought in. Especially important if the team is trying to do lots of fancy stuff.
Have reminded team of the importance of experimental design and measured data in the final evaluation of the projects.
Have reminded team of checkoff schedule for next three weeks -- breadboard, soldered and integrated, deployment at BFS
I have updated the instructor checkoff spreadsheet in the Project folder (this is important so that Prof. Brake can approve purchase orders)
