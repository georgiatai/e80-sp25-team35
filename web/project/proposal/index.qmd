...
Example: [Word](https://drive.google.com/open?id=1MRynJcT4hXLgHcVIO9rsjBFQ6UUU_kM_)
...
You will need to produce a project proposal and have it approved by two professors before spring break. The project proposal is made up of four parts: a budget indicating what you intend to buy for the project, a one-page maximum written description of your experiment, a mechanical drawing showing how you plan to mount or ruggedize the sensors for water submersion, and a detailed schematic showing how you will connect your new sensors to power and to the Teensy. Note that an example proposal is linked above.  The following sections describe each deliverable. **MORE RELEVANT EXAMPLE?**
